...
function Recetas({ db, actualizarDb }) {
    ...
    const editarReceta = (receta) => {
        setForm({
            ...
            unidades: receta.unidades, ingredientes: receta.ingredientes,
            insumos: receta.insumos || [],
            margenMay: receta.margenMay, margenMen: receta.margenMen,
    ...
    const guardarReceta = () => {
        ...
        const datos = { ...form, costoTotal, costoPorUnidad, precioMayoreo, precioMenudeo, fecha: new Date().toISOString() }
        if (editandoId) {
